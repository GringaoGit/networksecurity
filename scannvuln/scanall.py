...
def main():
    ...
    parser.add_argument("-p", metavar="", type=int, help="Single port ex: 80")
    parser.add_argument("--port", metavar="", type=int, help="Single port ex: 80")
    parser.add_argument("-pl", metavar="", help="Port list ex: 21,22,80")
    parser.add_argument("--portlist", metavar="", help="Port list ex: 21,22,80")
    parser.add_argument("-pr", metavar="", help="Port range ex: 20-30")
    parser.add_argument("--portrange", metavar="", help="Port range ex: 20-30")
    parser.add_argument("-t", metavar="", type=int, default=2, help="Timeout value (default 2)")
    parser.add_argument("--timeout", metavar="", type=int, default=2, help="Timeout value (default 2)")
