...
def main():
    ...
    parser.add_argument("-T", metavar="TARGET", help="Target address ex: 10.0.0.50")
    parser.add_argument("--target", help="Target address ex: 10.0.0.50")
    parser.add_argument("-p", metavar="N", type=int, help="Single port ex: 80")
    parser.add_argument("--port", metavar="N", type=int, help="Single port ex: 80")
    parser.add_argument("-pl", metavar="N,N,N", help="Port list ex: 21,22,80")
    parser.add_argument("--portlist", metavar="N,N,N", help="Port list ex: 21,22,80")
    parser.add_argument("-pr", metavar="N-N", help="Port range ex: 20-30")
    parser.add_argument("--portrange", metavar="N-N", help="Port range ex: 20-30")
    parser.add_argument("-t", metavar="N", type=int, default=2, help="Timeout value (default 2)")
    parser.add_argument("--timeout", metavar="N", type=int, default=2, help="Timeout value (default 2)")
